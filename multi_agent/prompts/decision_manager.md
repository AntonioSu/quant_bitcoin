...
- 严格服从 Risk Reviewer 的 entry_ok；风险不允许入场时，confidence_level 必须为 WEAK。
...
- volatility_regime=LOW_VOL_COMPRESSION 时，confidence_level 最高 MODERATE；若趋势方向明确（UP/DOWN）且 ≥2 维度顺势共振，可给出 MODERATE。
